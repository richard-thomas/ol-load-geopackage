...
- [loadGpkg()](#loadgpkggpkgfile-displayprojection-options) - start asynchronous loading and data extraction of GeoPackage
...
## loadGpkg(gpkgFile, displayProjection, options)
